...
- Gründungsjahr des Unternehmens (Einstellung `INVOICES_FOUNDING_YEAR`)
- Weitere selbständige Tätigkeiten derselben Person (§ 2 Abs. 1 Satz 2 UStG): welche, wo ihre
  Aufzeichnungen, Rechnungen und Belege geführt werden, wer sie führt, und wie ihre
